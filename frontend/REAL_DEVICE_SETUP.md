...
Look for "IPv4 Address" under your active network adapter (usually WiFi or Ethernet). It will look like `192.168.13.67` or `192.168.1.10`.
...
```env
EXPO_PUBLIC_API_URL=http://192.168.13.67:5000
```

(Replace `192.168.13.67` with YOUR laptop's IP)
...
```typescript
return "http://192.168.13.67:5000";
```

Replace `192.168.13.67` with your laptop's IP address.
...
1. On your phone, try opening in browser: `http://YOUR_LAPTOP_IP:5000/health`
   - Example: `http://192.168.13.67:5000/health`
...
- `192.168.13.67` (most likely)
- `192.168.1.10`

The code is currently set to use `192.168.13.67`. If your phone still can't connect, try `192.168.1.10` or check which IP your WiFi adapter is actually using.

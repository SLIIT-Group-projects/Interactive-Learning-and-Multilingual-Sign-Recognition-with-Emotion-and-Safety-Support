...
Phone browser can't open `http://192.168.1.9:5000/health`
...
Look for "IPv4 Address" under your WiFi adapter. It might be different from `192.168.1.9`.
...
2. **From phone browser:** `http://192.168.1.9:5000/health` ✅ Should work

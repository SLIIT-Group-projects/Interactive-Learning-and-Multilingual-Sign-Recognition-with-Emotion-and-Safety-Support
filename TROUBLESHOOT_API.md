...
curl http://192.168.13.67:5000/health
```
...
1. Open a browser
2. Go to: `http://192.168.13.67:5000/health`
...
- IP address matches in `PlayGame.js` (currently set to `192.168.13.67`)

### 6. Test from Phone Browser

If you can access `http://192.168.13.67:5000/health` from your phone's browser, the network is fine and the issue is in the app.
...
3. **Test from Phone Browser:**
   ...
   - Go to: `http://192.168.13.67:5000/health`
